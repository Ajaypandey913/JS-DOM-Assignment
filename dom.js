...
maincontainer.innerHTML = `<div class="containers">
<div class="clothsContainer"></div>
<div class="accessoriesContainer"></div>
</div>`;
// cloths section

const clothingheader = document.createElement("div");
clothingheader.innerHTML = `<h2 class="title">Clothing for Men and Women</h2>`;
document.querySelector(".clothsContainer").appendChild(clothingheader);
clothingheader.className = "parent";

const clothProducts = document.createElement("div");
clothProducts.className = "products";
document.querySelector(".clothsContainer").appendChild(clothProducts);

// accessosry section

const accessoriesheader = document.createElement("div");
accessoriesheader.innerHTML = `<h2 class="title">Accessories for Men and Women</h2>`;
document.querySelector(".accessoriesContainer").appendChild(accessoriesheader);
accessoriesheader.className = "parent";

const accessoriesProducts = document.createElement("div");
accessoriesProducts.className = "products";
document
  .querySelector(".accessoriesContainer")
  .appendChild(accessoriesProducts);

// DOM function

function creatingProduts(data) {
  // image
  const productCard = document.createElement("div");
  productCard.className = "product-Card";
  productCard.id = "product-id";
  productCard.innerHTML = `<img class="product-img" src="${data.preview}">`;

  // detail

  const productDetail = document.createElement("div");
  productDetail.className = "product-detail";
  productDetail.innerHTML = `<h3> ${data.name} `;
  ...
  productDetail.appendChild(productBrand);
  ...
  productBrand.appendChild(productPrice);

  data.isAccessory === true
    ? document
        .querySelector(".accessoriesContainer .products")
        .appendChild(productCard)
    : document
        .querySelector(".clothsContainer .products")
        .appendChild(productCard);
}

for (let eachProduct of productList) {
  creatingProduts(eachProduct);
}
